<template>
  <div>
    <el-dialog title="新建文档" v-if="Visible" :visible.sync="Visible" width="490px" top="5vh">
      <div style="width: 80%">
        文档标题:<br><br>
      ...
      <div>所属团队:</div><br>
      <div>
        <el-select v-model="NewFile.TeamId">
          <el-option label="个人" :value="-1">个人</el-option>
          <el-option v-for="(i) in Team" :label="i.Name" :value="i.Id">{{i.Name}}</el-option>
        </el-select>
      </div>
      <br>
      <div>
...
<script>
  ...
  let Data={
    Visible:false,
    NewFile:{Title:null,SimpleMessage:null,TeamId:null,Authority:null,Revise:null},
    Team:[
      {Name:'大北航帝国',Id:0},
      {Name:'大士谔书院',Id:1},
      {Name:'大软件学院',Id:2},
